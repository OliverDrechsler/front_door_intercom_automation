...
It supports [Blink](https://blinkforhome.com) camera's and my simple [PiCam_API_2](https://https://github.com/OliverDrechsler/PiCam_API_2) project.  
...
- [Front-door intercom automation - (FDIA)](#front-door-intercom-automation---fdia)
  ...
  - [Cameras](#cameras)
    ...
    - [Raspberry Pi Camera Project \_API](#raspberry-pi-camera-project-picam_api)
  - [Telegram](#telegram)
...
- Use of my Raspberry PI camera Project [PiCam_API](https://github.com/OliverDrechsler/PiCam_API) or [PiCam_API_2](https://github.com/OliverDrechsler/PiCam_API_2) Project.
