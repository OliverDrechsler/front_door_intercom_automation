...
class FDIaTestCase(unittest.TestCase):
    ...
    def test_Configuration(self):
        ...
        self.assertEqual(
            self.instance_configuration.telegram_token, "telegram_bot_token_code_here"
        )
        self.assertEqual(self.instance_configuration.telegram_chat_nr, "-4321")
        self.assertEqual(
            self.instance_configuration.allowed_user_ids, ["123456789", "987654321"]
        )
        self.assertEqual(
            self.instance_configuration.otp_password, "KRSXG5CQIASCIVZQOJCA===="
        )
        ...
        self.assertEqual(
            self.instance_configuration.blink_password, "blink_account_password_here"
        )
        self.assertEqual(
            self.instance_configuration.blink_name, "Blink_Camera_name_here"
        )
        self.assertEqual(
