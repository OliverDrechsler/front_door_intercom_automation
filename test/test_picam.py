...
class DoorTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.patch_requests_post = patch('camera.picam.requests.post', 
        ...
        self.patch_requests_get = patch('camera.picam.requests.get', 
            return_value = MagicMock())
    ...
    def test_request_take_foto(self):
        ...
        expected_log = [
            ...
            "DEBUG:PiCam:{'rotation': 0, 'width': 640, 'filename': 'foto.jpg', 'hight': 480, 'exposure': 'auto', 'iso': 0}", "DEBUG:PiCam:{'content-type': 'application/json'}", 
