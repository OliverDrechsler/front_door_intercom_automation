...
class DoorTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.patch_date_time = patch('door.bell.datetime', return_value=MagicMock())
        self.mock_date_time = self.patch_date_time.start()
        self.mock_date_time.datetime.now.return_value = " Now"
    ...
    def test_usecase1_door_bell_ring(self, test=True):
        ...
        expected_ring_log = [
            ...
            f"INFO:send_telegram_msg:send message : Ding Dong!{self.mock_date_time.datetime.now.return_value}", 
        ...
        self.bot.sendMessage.assert_called_with('-4321', 'Ding Dong! Now')
