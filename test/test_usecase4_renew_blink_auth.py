...
class TelegramMessagesTestCase(unittest.TestCase):
    ...
    def test_usecase3_gather_foto_from_front_door(self):    
        ...
        expected_method_log = [
            ...
            f"INFO:fdia_telegram:chat msg allowed: user FirstName with from_id {self.CONFIG_DICT['telegram']['allowed_user_ids'][0]} is in config",             'DEBUG:fdia_telegram:text match blink found', 
